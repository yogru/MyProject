...
<link rel="stylesheet" href="/resources/daumOpenEditor/css/editor.css"
	type="text/css" charset="UTF-8" />
<script src="/resources/daumOpenEditor/js/editor_loader.js?"
...
<script type="text/javascript">
	var config = {
		...
		sidebar: {
			...
			attacher:{ 
				       image:{ features:{left:250,top:65,width:400,height:190,scrollbars:0}, 
				       popPageUrl:'${pageContext.request.contextPath}/upload/imagePopup' 
			         }
			}
		},
		size: {
			contentWidth: 1920 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
		}
	};
